...
export function Search({ className = '', placeholder = 'Search' }: Props) {
  ...
  return (
    ...
    >
      ...
      <kbd className='bg-muted pointer-events-none absolute top-[0.3rem] end-[0.3rem] hidden h-5 pt-1 items-center gap-1 rounded border px-1.5 font-mono text-[10px] font-medium opacity-100 select-none sm:flex'>
